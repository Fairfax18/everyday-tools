...
export default function Home() {
  const tools = [
    ...
    { name: 'Word Counter', path: '/word-counter', desc: 'Count words, characters, and reading time.', icon: '📝' },
    { name: 'Password Generator', path: '/password-generator', desc: 'Create strong, secure random passwords.', icon: '🔐' },
  ];

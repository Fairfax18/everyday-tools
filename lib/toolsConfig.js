export const toolsCategories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Markdown Editor', path: '/text/markdown-editor', desc: 'Real-time Markdown rendering.' }
    ]
  },
  {
    title: 'Math & Finance',
    ...
    tools: [
      ...
      { name: 'Investment Calculator', path: '/math/investment', desc: 'Model dividends and growth.' }
    ]
  },
  {
